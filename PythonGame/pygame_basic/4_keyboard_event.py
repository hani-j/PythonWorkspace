...
character_x_pos = screen_width / 2 - character_width # 화면 가로의 절반 크기에 해당하는 곳에 위치 (가로)
...
while running:
	for event in pygame.event.get(): # 어떤 이벤트가 발생하였는가? # 무조건
